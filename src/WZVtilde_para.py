...
def setModelParametersFromFile(paramsFromFile, nDims):
  ...
  NN_param_list = ['chiUnderline','a_e','a_h','gamma_e','gamma_h','psi_e','psi_h',\
                   ...
                   'cov11','cov12','cov13','cov21','cov22','cov23','cov31','cov32','cov33']
  ...
  params['sigmaVtilde']            = tf.concat([params['cov31'] * params['sigma_Vtilde_norm'],  params['cov32'] * params['sigma_Vtilde_norm'],  params['cov33'] * params['sigma_Vtilde_norm']], 0) 
